      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h2 className="text-3xl font-bold tracking-tight text-gray-900">Electoral Commission Dashboard</h2>
              <p className="text-gray-600">Chairperson - Election Results Monitoring</p>
            </div>
          </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-200">
                  <span className="font-medium text-green-800">Election Active</span>
                  <Badge className="bg-green-500">Live</Badge>
                </div>
                <div className="text-sm text-gray-600 space-y-2">
                  <p>• Voting is currently in progress</p>
                  <p>• Real-time results monitoring active</p>
